...
# PLease read the GNU Affero General Public License in <https://www.github.com/MR-UNKNOWN-X/testing/blob/main/LICENSE/>.

FROM programmingerror/ultroid:v0.0.1

RUN git clone https://github.com/MR-UNKNOWN-X/testing.git /root/MR-UNKNOWN-X/
